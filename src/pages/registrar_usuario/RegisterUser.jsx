    ...
    return (
        <div className="flex flex-col  min-h-screen bg-gray-100">
            ...
            <div className="grid grid-cols-12 md:flex-row gap-10 col-span-12">
                ...
                <form className="bg-white p-6 rounded-lg shadow-lg w-full col-span-5" method="POST">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className="p-2 border border-gray-200">
                                    ...
                                    <Button onClick isIconOnly className="bg-blue-700 rounded-md">
                                        <IoEye className="text-white" />
                                    </Button>



                                    <Button isIconOnly className="bg-green-700 text-white rounded mx-1">
