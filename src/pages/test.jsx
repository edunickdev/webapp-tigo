          ...
          {/* filas*/}
            ...
            <View style={styles.formcolumn}>
              ...
              <View style={[styles.contenedor__text]}>
                  <Text > - Responsabilidad en cuanto al cuidado de las herramientas de trabajo:</Text>
                ...
                <View style={[styles.contenedor__text]}>
                  ...
                  <Text>Comprendo que las herramientas de trabajo están destinadas para propósitos propios de la organización, por tanto, está prohibido instalar aplicativos personales en estos o realizar sobre las mismas modificaciones sin previa autorización expresa y escrita de la CORPORACIÓN, a través de su área de informática.  Aquellos requerimientos especiales para aplicaciones no estándares deben estar acompañados por una justificación de negocio y deben ser manejados solo por personal del área de informática debidamente autorizada. Igualmente, que está prohibido el uso de equipos y software instalado en estos, referido en el párrafo anterior, para crear, bajar de internet o distribuir material ofensivo, inmoral y en general inapropiado.  Me comprometo a utilizar los datos de carácter personal a los que tenga acceso, única y exclusivamente para cumplir con las obligaciones laborales y a mantener la confidencialidad de toda la información que llegue a mi conocimiento en virtud del contrato suscrito, comprometiéndome a no comunicar a terceros, ni usar en mi propio provecho, las informaciones de naturaleza reservada que tenga o llegue a conocer y cuya divulgación pueda ocasionar perjuicios a la Corporación. Lo anterior, también aplica al uso adecuado de claves de usuario a sistemas de información y del software corporativo. 
                  </Text>
                  <Text > - Responsabilidad en cuanto a medidas de Salud y Seguridad en el Trabajo:</Text>
                  <Text > Sé que debo cumplir las condiciones especiales sobre la prevención de riesgos laborales que se encuentran definidas en el Sistema de Seguridad y Salud en el Trabajo y hacen parte integral de este documento, las cuales declaro conocer porque me han sido debidamente informadas por parte de la Corporación. Por lo tanto, me comprometo igualmente a cumplir con todas las medidas de seguridad y previsión de {'\n'}riesgos y normas de SGSST en relación con el uso de las herramientas de trabajo. Para las personas que estén bajo la modalidad de teletrabajo, el puesto de trabajo en el domicilio o dirección alterna registrada deberá contar con las siguientes condiciones mínimas:  
                  </Text>
                  <View>
                      <Text style={styles.text2}>
                        - Contar con un lugar tranquilo, silencioso, preferiblemente con iluminación natural y adecuada ventilación. 
                      </Text>
                      <Text style={styles.text2}>
                        - Se deben evitar sombras o zonas de penumbra sobre la superficie de trabajo. 
                      </Text>
                      <Text style={styles.text2}>
                        - Dimensiones sugeridas para la superficie de trabajo:  mínimo 120 cm. de ancho, 60 cm. de profundidad, 73 - 74 cm. de alto. 
                      </Text>
                      <Text style={styles.text2} >
                        - El espacio por debajo de la superficie debe estar libre de objetos que puedan restringir la movilidad de las piernas.  
                      </Text>
                      <Text>
                        - Superficie de trabajo con acabado mate. No se recomienda vidrio o en piedra. 
                      </Text>
                      <Text>
                        - La silla debe ser de material transpirable, con asiento graduable en altura, espaldar con apoyo dorsolumbar, que permita un adecuado balance corporal y soporte de espalda, muslos y glúteos durante la postura sedente. 
                      </Text>
                      <Text>
                        - Si ha de emplear un equipo portátil, debe contar con teclado y mouse auxiliar a fin de elevar la altura de la pantalla. 
                      </Text>
                      <Text>
                        - La pantalla debe ubicarse de frente al trabajador (no de lado). 
                      </Text>
                      <Text>
                        - El borde superior de la pantalla debe ubicarse al mismo nivel de los ojos y a una distancia entre 50-60 cm. del trabajador. 
                      </Text>
                      <Text>
                        - Debe contar con un apoyo para las muñecas y parte del antebrazo de mínimo 15 cm. por delante del teclado y mouse. 
                      </Text>
                      <Text>
                        - El teclado y mouse deben estar a la misma altura y profundidad sobre la superficie de trabajo. 
                      </Text>
                      <Text>
                        - Contar con conexión eléctrica cerca al puesto de teletrabajo, a fin de evitar el uso de extensiones. 
                      </Text>
                      <Text>
                        - Evitar el uso de multitomas sobrecargadas y organizar el cableado por debajo de la superficie de trabajo. 
                      </Text>
                      <Text>
                        - El acceso al puesto de trabajo debe estar libre de cualquier obstáculo.
                      </Text>
                    </View>
                </View>
            </View>
                ...
                <View style={styles.button}>
                    ...
                    <View style={styles.formRow_header_firma}> 
                        <Text style={styles.formRow_header_nombre_1_1}>Nombre Completo: {'MANUEL FERNANDO SUAREZ SANCHEZ'}</Text>
                        <Text style={styles.formRow_header_nombre_1_1}>Nombre Completo:{'LIZ CAROL MOLINA RINCON'}</Text>
                    </View>  
                    <View style={styles.formRow_header_22}> 
                        <Text style={styles.formRow_header_1_1}>ATENCIÓN AL TRABAJADOR</Text>
                ...
                <View style={styles.text_footer}>
                  ...
                  <Text style={{ marginBottom: 15 }}>Los trabajadores bajo la modalidad de trabajo de teletrabajo autónomo que cuenten con equipos y herramientas de propiedad de proveedores deben ser relacionadas en la presente acta. </Text>
                  <Text style={{ marginBottom: 15 }}>Colsubsidio asigna a cada trabajador a través de su jefe inmediato mediante el presente anexo formal de entrega, las herramientas de trabajo que considere necesarias para garantizar el desarrollo de las funciones o acordará con éste el desarrollo de las mismas con sus propios medios según la modalidad de trabajo y cargo, siguiendo para ello los lineamientos establecidos por la Corporación. A continuación, se encuentran los lineamientos establecidos para el diligenciamiento de la presente acta:</Text>
                  <View style={{ marginBottom: 15 }}>
                    <Text>1. El trabajador deberá suscribir la presente acta de entrega de equipos, herramientas y facilidades operativas diligenciando todos los campos por escrito</Text>
                    <Text>2. El área de TI acompañara al jefe inmediato en la entrega de los equipos y/o herramientas solicitadas por el jefe inmediato firmando la presente acta por medio de su representante.</Text>
                    <Text>3. El jefe inmediato es el responsable de garantizar la entrega de los equipos, herramientas y facilidades operativas al trabajador.</Text>
                    <Text>4. El jefe inmediato cargará en el Share Point ACTAS DE ENTREGA FACILIDADES OPERATIVAS; La dependencia de atención al trabajador se encargará del control, chequeo y archivo en hoja de vida. </Text>
                  </View>
                  <View style={{ marginBottom: 15 }}>
                    <Text style={{ marginBottom: 3 }}>Teletrabajo autónomo: Modalidad en la cual el trabajador labora el 100% de su jornada laboral en su domicilio principal o alterno reportado ante Colsubsidio, dentro de la ciudad en la cual fue vinculado como sede de trabajo.</Text>
                    <Text>Teletrabajo suplementario: Modalidad en la cual el trabajador alterna su jornada laboral con trabajo presencial en la sede de Colsubsidio y el domicilio del trabajador registrado. </Text>
                  </View>
